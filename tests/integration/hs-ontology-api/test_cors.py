"""
Tests for hs-ontology-api CORS configuration.
...
Run all CORS tests:
    TEST_API="hs-ontology-api" pytest tests/localhost/integration/hs-ontology-api/test_cors.py -v
"""
...
# Note: no test_cors_headers_on_protected_endpoints — all hs-ontology-api
# endpoints are public, so there are no 401 responses to test against.
