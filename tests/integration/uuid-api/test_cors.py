"""
Tests for uuid-api CORS configuration.

Run all CORS tests:
    TEST_API="uuid-api" pytest tests/localhost/integration/uuid-api/test_cors.py -v
"""
...
def test_cors_headers_on_protected_endpoints(base_url):
    ...
    r = requests.get(f"{base_url}/uuid/32323232323232323232323232323232/exists", timeout=TIMEOUT)
